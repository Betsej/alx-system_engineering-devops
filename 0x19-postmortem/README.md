...
## Timeline
The error was realized on Thursday 5th July 1000 hours (West Africa Time) when Mr Isaac saw the master server lagging in speed. Our engineers on call disconnected the master server web-01 for further system analysis and channelled all requests to client server web-02. They solved problem by Friday 06th July 2200 hours (West Africa Time).
...
- Always keep an eye on your servers to ensure they are running efficiently
